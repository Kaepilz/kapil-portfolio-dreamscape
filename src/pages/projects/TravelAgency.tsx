  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0c1e36] to-kapil-blue-dark">
      <div className="relative h-[500px] overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 py-6">
          <div className="flex justify-between items-center">
            <Link to="/">
              <Button variant="outline" className="mb-2 bg-background/20 backdrop-blur-sm">
          ...
          <div className="mt-16 md:mt-24 text-center">
            <h1 className="text-3xl md:text-5xl font-bold mb-4">Discover Your Dream Destinations</h1>
                ...
                <Tabs defaultValue="flights" value={selectedTab} onValueChange={setSelectedTab}>
                  ...
                  <TabsContent value="packages" className="space-y-4">
                    <div className="text-center p-4">
                      <h3 className="text-lg font-medium mb-2">All-inclusive Vacation Packages</h3>
                  ...
                  <TabsContent value="activities" className="space-y-4">
                    <div className="text-center p-4">
                      <h3 className="text-lg font-medium mb-2">Explore Local Experiences</h3>
                      <p className="text-sm text-muted-foreground mb-4">
      ...
      <div className="container mx-auto px-4 py-12 space-y-16">
            ...
            {FEATURED_DESTINATIONS.map(destination => (
              ...
              >
                ...
                <CardFooter className="flex gap-2">
                  <Button 
                    className="flex-1 bg-kapil-red hover:bg-kapil-red/90"
                ...
                {selectedDestination === destination.id && (
                  <div className="p-4 border-t border-kapil-blue-light/20 bg-kapil-blue-dark/60">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {POPULAR_EXPERIENCES.map(experience => (
              <Card key={experience.id} className="bg-kapil-blue-medium/50 overflow-hidden group">
        ...
        {/* Newsletter */}
        <div className="bg-kapil-blue-medium/50 rounded-xl p-6 md:p-8 lg:p-12 text-center">
